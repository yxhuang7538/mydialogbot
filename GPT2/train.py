...
def set_args():
    ...
    parser.add_argument('--vocab_path', default='../datasets/vocab.txt', type=str, required=False,
                        help='词表路径')
    parser.add_argument('--model_config', default='../configs/gpt2.json', type=str, required=False,
                        help='设置模型参数')
    parser.add_argument('--train_path', default='../datasets/50w/train_50w.pkl', type=str, required=False, help='训练集路径')
