...
def preprocess():
    ...
    parser.add_argument('--vocab_path', default='../datasets/vocab.txt', type=str, required=False,
                        help='词表路径')
    parser.add_argument('--train_path', default='../datasets/50w/train_50w.txt', type=str, required=False, help='训练日志存放位置')
    parser.add_argument('--save_path', default='../datasets/50w/train_50w.pkl', type=str, required=False, help='tokenize的训练数据集')
